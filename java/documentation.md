...
the snapshot build (master branch), which is built with [Jitpack][5] for
...
dependencies {
    ...
    compile compile 'com.github.pgjdbc:pgjdbc:aster-SNAPSHOT'
```
...
[5]: https://jitpack.io/#pgjdbc/pgjdbc
